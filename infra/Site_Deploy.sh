...
#docker pull node:14
# build node web server image from source code according to dockerfile configuration
...
# executed commands inside postgreSQL container are to be as user postgres
# explanation of docker daemon output of following command in terminal
